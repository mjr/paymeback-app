...
Future<Map<String, dynamic>> fetchData() async {
  ...
  return {
    ...
    'charges': response["charges"].map<Charge>((charge) => Charge.fromJson(charge)).toList()
  };
}
...
class _InsightState extends State<Insight> {
  Future<Map<String, dynamic>> _initialization = fetchData();
                  ...
                  Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          width: 3, color: Color(0xFFE8E8E8), style: BorderStyle.solid
                        ),
                      ),
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: GoogleFonts.inter(fontSize: 12, color: Color(0xFFBDBDBD)),
                          )
                        ]
                      ),
                    ),
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, index) {
                        ...
                        } else if (!snapshot.data!['charges'][index].paid) {
                                ...
                                Expanded(
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          snapshot.data!['charges'][index].debtor,
                                          style: GoogleFonts.inter(
                                            fontSize: 16,
